...
GO
INSERT [dbo].[fixedpriceconfig] ([id], [tarifftypeid], [seasonid], [monthno], [pricelevelid], [total], [fixed], [taxes], [uomid], [pricefromdate], [pricetodate]) VALUES (72, 14, 5, 12, 4, CAST(200.0000 AS Decimal(10, 4)), CAST(160.0000 AS Decimal(10, 4)), CAST(40.0000 AS Decimal(10, 4)), 1, CAST(N'2020-11-01' AS Date), CAST(N'2021-12-31' AS Date))
GO
