...
namespace GridTariffApi
{
    public static class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var deploymentRoleConfig = host.Services.GetRequiredService<DeploymentRoleConfig>();
            logger.TrackEvent($"StartupTasksDispatched_Starting{deploymentRoleConfig.Role}Host", new { DeplymentRole = deploymentRoleConfig.Role.ToString() });
            await host.RunAsync();
        }
